...
<div className='dark:bg-gray-900  w-[300px] md:w-[400px] p-6'>
  <h2 className='text-xl md:text-2xl font-semibold mt-4 md:mt-6 text-gray-900 dark:text-gray-100 mb-2'>
    Start a New Interview Journey
  </h2>
  
  <p className='text-gray-600 dark:text-gray-400 mb-6 text-sm'>
    Fill out this form and unlock your personalized set of interview questions
  </p>
  ...
  <form onSubmit={handleSubmit} className='flex flex-col gap-4 md:gap-6'>
    ...
    <button
      type="submit"
      className="w-full flex items-center justify-center gap-x-2 cursor-pointer bg-[#0F172A] text-white font-semibold py-2 px-4 rounded-md hover:bg-[#1E293B] dark:bg-[#1E293B] dark:hover:bg-[#334155] transition"
    >
