  ...
  return (
      ...
      <section className="pt-12 bg-gray-50 sm:pt-16">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="max-w-2xl mx-auto text-center">
            <h1 className="px-6 text-lg text-gray-600">Master every interview with precision and AI guidance</h1>
    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="text-center">
            ...
            <p className="mt-4 text-base leading-7 text-gray-600 sm:mt-8 font-pj">Get role-specific questions. Expand answers when you need them, dive deeper into concepts and organize everything your way.</p>
        </div>
          ...
          >
           <div className="relative">
            <RxCross1
              ...
              className="absolute top-2 right-2 cursor-pointer text-gray-700 hover:text-black"
            />
